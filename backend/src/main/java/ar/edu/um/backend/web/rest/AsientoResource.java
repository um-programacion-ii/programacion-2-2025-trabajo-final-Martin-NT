...
public class AsientoResource {
    ...
    public ResponseEntity<AsientoDTO> createAsiento(@Valid @RequestBody AsientoDTO asientoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/asientos/" + asientoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, asientoDTO.getId().toString()))
            .body(asientoDTO);
    }
    ...
    public ResponseEntity<AsientoDTO> updateAsiento(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, asientoDTO.getId().toString()))
            .body(asientoDTO);
    }
    ...
    public ResponseEntity<AsientoDTO> partialUpdateAsiento(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, asientoDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public List<AsientoDTO> getAllAsientos(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
