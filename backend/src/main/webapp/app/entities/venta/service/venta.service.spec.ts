...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../venta.test-samples';

import { RestVenta, VentaService } from './venta.service';

const requireRestSample: RestVenta = {
  ...sampleWithRequiredData,
  fechaVenta: sampleWithRequiredData.fechaVenta?.format(DATE_FORMAT),
};
