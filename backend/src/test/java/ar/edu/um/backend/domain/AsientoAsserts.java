...
public class AsientoAsserts {
    ...
    public static void assertAsientoUpdatableFieldsEquals(Asiento expected, Asiento actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getPersonaActual()).as("check personaActual").isEqualTo(expected.getPersonaActual()));
    }
    ...
    public static void assertAsientoUpdatableRelationshipsEquals(Asiento expected, Asiento actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getVentas()).as("check ventas").isEqualTo(expected.getVentas()));
    }
}
