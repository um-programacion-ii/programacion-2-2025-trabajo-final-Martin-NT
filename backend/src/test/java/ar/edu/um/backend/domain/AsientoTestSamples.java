...
public class AsientoTestSamples {
    ...
    public static Asiento getAsientoSample1() {
        return new Asiento().id(1L).fila(1).columna(1).personaActual("personaActual1");
    }

    public static Asiento getAsientoSample2() {
        return new Asiento().id(2L).fila(2).columna(2).personaActual("personaActual2");
    }
    ...
    public static Asiento getAsientoRandomSampleGenerator() {
        return new Asiento()
            ...
            .personaActual(UUID.randomUUID().toString());
    }
}
